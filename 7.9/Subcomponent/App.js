...
class App extends Component {
	...
	let l = data.map(e=>{
		return <div key={new Date} className='information'>
						<p>
							<span>账户名</span>
							<span>{e.content}</span>
						</p>
	...
	let p = data.map(e=>{
		return 	<div key={(new Date)+1} className='changeMain'>
						<p>
							<span>手机</span>
							<input
								onChange={this.phC}
               ...
               <Link to='/admin' oid='8'  onClick={this.click}> <i>></i>管理员列表</Link>
				...
				<div className='personal'>
					...
					{/* <div className='information'>
						<p>
							<span>账户名</span>
							<span>小辉零售价按倒过来看积分</span>
						</p>
						<p>
							<span>手机</span>
							<span>132413454565456</span>
						</p>
						<p>
							<span>邮箱</span>
							<span>4354545456456</span>
						</p>
						<p>
							<span>用户等级</span>
							<span>0</span>
				...
				<div className='changeInfo'>
					...
					{/* <div className='changeMain'>
						...
						<p>
							...
							<input className='mustSure' type='password' placeholder='再次确认密码'/>
						</p>
						<p className='grade'>
							<span>用户等级</span>
							<select>
						...
						<div className='minSure'>确认修改</div>
						<div 
							onClick = {this.canl}
							className='cancel'>取消</div>
					</div> */}
